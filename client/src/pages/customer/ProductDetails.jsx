        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mt-10">
            ...
            <div className="flex flex-col justify-center">
              <p className="text-sm text-gray-400 uppercase tracking-[4px] mb-3">
                {product.category}
              </p>
              ...
              <p className="text-gray-400 leading-7 max-w-lg mb-8">
                Experience quality and style with the{" "}
                {product.name}. Designed for everyday use,
                this product combines comfort, functionality,
                and modern design.
              </p>
              ...
              {product.stock > 0 && (
                <div className="mb-8">
                  ...
                  <div className="flex items-center w-fit border border-white/30 rounded-lg">
                    <button
                      onClick={decrease}
                      className="w-10 h-10 hover:bg-white hover:text-black transition"
                    >
                      −
                    </button>
              ...
              <button
                ...
                className="w-full md:w-80 bg-white text-black py-3 rounded-full font-semibold border border-white hover:bg-black hover:text-white disabled:bg-gray-700 disabled:text-gray-400 disabled:border-gray-700 transition"
              >
                {product.stock > 0
                  ? "Add to Cart"
                  : "Out of Stock"}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {relatedProducts.map(related => (
                <Link
                  ...
                  className="bg-white text-black rounded-2xl overflow-hidden hover:shadow-2xl transition duration-300"
                >
